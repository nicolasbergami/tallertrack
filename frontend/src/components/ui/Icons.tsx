// Central SVG icon library — stroke-based, consistent strokeWidth={1.75}
// All icons default to w-5 h-5 via className prop

type IconProps = { className?: string };

export const IconOrders     = ({ className = "w-5 h-5" }: IconProps) => (
...
export const IconHistory    = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
...
export const IconQr         = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12v.01M12 4H4v8h8V4zm0 8v8h8v-8h-8zM4 4v8" />
  </svg>
);
...
export const IconTeam       = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
